	...
	//<![CDATA[
		...
		function updateConversionProgress(songFile)
		{
			...
			$.ajax({
				...
				data : "uniqueId=1610950698_6005282a259a64.22948888&logLength=" + conversionLogLength + "&mp3File=" + encodeURI(songFile),
				...
				<div class="overlay">
					...
					<div class="converter text-center" style="color:#f48024;">
						...
						-->
							...
							<p><input type="hidden" name="formToken" value="1610950698_6005282a259a64.22948888" /><button type="submit" name="submit" class="btn btn-primary" value="Create MP3 File" style="background:#82C013;;"><i class="fa fa-cogs"></i>Make my MP3!</button></p>
						</form>
					</div><!-- ./converter -->			
