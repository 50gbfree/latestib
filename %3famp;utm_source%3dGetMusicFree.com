	...
	//<![CDATA[
		...
		function updateConversionProgress(songFile)
		{
			...
			$.ajax({
				...
				data : "uniqueId=1606661511_5fc3b587b9b084.69931405&logLength=" + conversionLogLength + "&mp3File=" + encodeURI(songFile),
				...
				<div class="overlay">
					...
					<div class="converter text-center" style="color:#f48024;">
						...
						-->
							...
							<p><input type="hidden" name="formToken" value="1606661511_5fc3b587b9b084.69931405" /><button type="submit" name="submit" class="btn btn-primary" value="Create MP3 File" style="background:#82C013;;"><i class="fa fa-cogs"></i>Make my MP3!</button></p>
						</form>
					</div><!-- ./converter -->			
